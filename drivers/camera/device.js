    ...
    if (this.repairing) {
      ...
      try {
        ...
        try {
          ...
          let capabilities = await this.homey.app.getServiceCapabilities(
            this.cam
          );
          this.homey.app.updateLog(
          ...
          if (Array.isArray(services)) {
            services.forEach((service) => {
              ...
              if (service.namespace.search(".org/") > 0) {
                let namespaceSplitted = service.namespace
                  .split(".org/")[1]
                  .split("/");
                if (
      ...
      if (this.snapshotSupported) {
        if (delay > 0) {
          await new Promise((resolve) =>
            this.homey.setTimeout(resolve, delay * 1000)
          );
        }
