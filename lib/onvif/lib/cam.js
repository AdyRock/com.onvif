...
Cam.prototype._request = function (options, callback) {
	...
	Homey.app.updateLog("_request: " + Homey.app.varToString(reqOptions) + "\nBody: " + Homey.app.varToString(options.body));
	...
	try {
		...
		Homey.app.updateLog("Request error: " + err.stack, true);
	...
	req.on('error', function (err) {
		Homey.app.updateLog("Request error: " + Homey.app.varToString(err), true);
		if (callbackExecuted === true) {
			return;
		}
		callbackExecuted = true;
