...
Cam.prototype._request = function(options, callback)
{
    ...
    req = http.request(reqOptions, function(res)
    {
        ...
        res.on('error', function(err)
        {
            ...
            {
                callbackExecuted = true;
                callback.call(this, new Error('Network error'));
            }
            req.destroy();
            return null;
        });
    ...
    req.setTimeout(reqOptions.timeout, function()
    {
        ...
        {
            callbackExecuted = true;
            _this.homey.app.updateLog("Request timeout (" + _this.hostname + ")", 3);
            callback.call(this, new Error('Network timeout'));
        }
        req.destroy();
        return null;
    });
    ...
    {
        _this.homey.app.updateLog("Request error (" + _this.hostname + "): " + _this.homey.app.varToString(err), 3);
        if (callbackExecuted === false)
        {
            callbackExecuted = true;
            callback.call(this, err);
        ...
        if (!err)
        {
                ...
                data[0].getSystemDateAndTimeResponse[0].systemDateAndTime[0].UTCDateTime[0])
            {
                try
                {
                    ...
                    return callback.call(this, err, time, xml);
                }
                catch (err)
                {
...
Cam.prototype.setSystemDateAndTime = function(options, callback)
{
    ...
    {
        return callback.call(this, new Error('DateTimeType should be `Manual` or `NTP`'));
    }
    this._request(
    {
        body: this._envelopeHeader() +
...
Cam.prototype.getCapabilities = function(callback)
{
    ...
    }, function(err, data, xml)
    {
        ...
        if (callback)
        {
            return callback.call(this, err, this.capabilities, xml);
        }
    }.bind(this));
};
...
Cam.prototype.getServiceCapabilities = function(callback)
{
    ...
    }, function(err, data, xml)
    {
        ...
        if (callback)
        {
            return callback.call(this, err, this.serviceCapabilities, xml);
        }
    }.bind(this));
};
...
Cam.prototype.getServices = function(includeCapability, callback)
{
    ...
    }, function(err, data, xml)
    {
        ...
        if (callback)
        {
            return callback.call(this, err, this.services, xml);
        }
    }.bind(this));
};
...
Cam.prototype.getDeviceInformation = function(callback)
{
    ...
    }, function(err, data, xml)
    {
        ...
        if (callback)
        {
            return callback.call(this, err, this.deviceInformation, xml);
        }
    }.bind(this));
};
...
Cam.prototype.getHostname = function(callback)
{
    ...
    }, function(err, data, xml)
    {
        if (callback)
        {
            return callback.call(this, err, err ? null : linerase(data).getHostnameResponse.hostnameInformation, xml);
        }
    }.bind(this));
};
...
Cam.prototype.getScopes = function(callback)
{
    ...
    }, function(err, data, xml)
    {
        ...
        if (callback)
        {
            return callback.call(this, err, this.scopes, xml);
        }
    }.bind(this));
};
...
Cam.prototype.setScopes = function(scopes, callback)
{
    ...
    }, function(err, data, xml)
    {
        ...
        {
            return callback.call(this, linerase(data).setScopesResponse !== '' ? new Error('Wrong `SetScopes` response') : err, data, xml);
        }
...
Cam.prototype.systemReboot = function(callback)
{
    ...
    }, function(err, res, xml)
    {
        ...
        return callback.call(this, err, res, xml);
    });
};
