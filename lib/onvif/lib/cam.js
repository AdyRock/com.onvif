...
Cam.prototype.getActiveSources = function () {
	...
	this.videoSources.forEach(function (videoSource, idx) {
		...
		this.activeSources[idx] = {
			...
			width: this.defaultProfiles[idx].videoEncoderConfiguration.resolution ? this.defaultProfiles[idx].videoEncoderConfiguration.resolution.width : 0,
			height: this.defaultProfiles[idx].videoEncoderConfiguration.resolution ? this.defaultProfiles[idx].videoEncoderConfiguration.resolution.height : 0,
			fps: this.defaultProfiles[idx].videoEncoderConfiguration.rateControl ? this.defaultProfiles[idx].videoEncoderConfiguration.rateControl.frameLimit : 0,
