...
Cam.prototype._request = function(options, callback)
{
    ...
    req.setTimeout(reqOptions.timeout, function()
    {
        if (callbackExecuted === false)
        {
            ...
            callback(new Error('Network timeout'), null, null);
        }
        req.destroy();
        return null;
    });
...
Cam.prototype.setSystemDateAndTime = function(options, callback)
{
    ...
    }, function(err, data, xml)
    {
        ...
        {
            return callback(err || (linerase(data).setSystemDateAndTimeResponse !== '') ?
...
Cam.prototype.getCapabilities = function(callback)
{
    ...
    }, function(err, data, xml)
    {
        ...
        if (callback)
        {
            return callback(err, this.capabilities, xml);
        }
    }.bind(this));
};
...
Cam.prototype.getServiceCapabilities = function(callback)
{
    ...
    }, function(err, data, xml)
    {
        ...
        if (callback)
        {
            return callback(err, this.serviceCapabilities, xml);
        }
    }.bind(this));
};
...
Cam.prototype.getServices = function(includeCapability, callback)
{
    ...
    }, function(err, data, xml)
    {
        ...
        if (callback)
        {
            return callback(err, this.services, xml);
        }
    }.bind(this));
};
...
Cam.prototype.getDeviceInformation = function(callback)
{
    ...
    }, function(err, data, xml)
    {
        ...
        if (callback)
        {
            return callback(err, this.deviceInformation, xml);
        }
    }.bind(this));
};
...
Cam.prototype.getHostname = function(callback)
{
    ...
    }, function(err, data, xml)
    {
        if (callback)
        {
            return callback(err, err ? null : linerase(data).getHostnameResponse.hostnameInformation, xml);
        }
    }.bind(this));
};
...
Cam.prototype.getScopes = function(callback)
{
    ...
    }, function(err, data, xml)
    {
        ...
        if (callback)
        {
            return callback(err, this.scopes, xml);
        }
    }.bind(this));
};
