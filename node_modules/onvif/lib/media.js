 ...
 * @property {('JPEG'|'MPEG4'|'H264')} encoding Used video codec
 ...
 * @param {('JPEG'|'H264'|'MPEG4')} [options.encoding] Encoding
 ...
 * @param {('SP'|'ASP')} options.MPEG4.profile the Mpeg4 profile
 * @param {object} [options.H264]
 * @param {number} options.H264.govLength Group of Video frames length
 * @param {('Baseline'|'Main'|'Extended'|'High')} options.H264.profile the H.264 profile
 ...
 * @param {('IPv4'|'IPv6')} options.multicast.address.type Indicates if the address is an IPv4 or IPv6 address
